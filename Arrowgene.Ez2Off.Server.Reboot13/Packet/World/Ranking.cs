...
{
    public class Ranking : Handler<EzServer>
    {
        public override int Id => 0x1A;

        public Ranking(EzServer server) : base(server)
        {
        }
        ...
        public override void Handle(EzClient client, EzPacket packet)
        {
            ...
            Logger.Debug(client, $"RankingType: {rankingType} Page: {page}");
            ...
            Router.Send(client, 0x25, buffer);
        }
    }
}