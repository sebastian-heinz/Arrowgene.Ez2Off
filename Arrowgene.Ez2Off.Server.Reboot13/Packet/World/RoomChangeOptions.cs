...
namespace Arrowgene.Ez2Off.Server.Reboot13.Packet.World
{
    public class RoomChangeOptions : Handler<EzServer>
    {
        ...
        public override void Handle(EzClient client, EzPacket packet)
        {
            ...
            packet.Data.ReadByte();
            client.Room.Password = packet.Data.ReadFixedString(4); // 1비밀번호 4BYTE
            packet.Data.ReadByte();
            packet.Data.ReadByte();
            packet.Data.ReadByte();
            packet.Data.ReadByte();
            ...
            Result.WriteInt16(0x6A, Endianness.Big);
            Result.WriteInt16(client.Room.Number, Endianness.Big);
            Result.WriteByte(0);
            Result.WriteByte(0);
            Result.WriteByte(0);
            ...
            Result.WriteByte(0);
            Result.WriteFixedString(client.Room.Name, 20, Utils.KoreanEncoding); // 방 이름 21byte
            Result.WriteByte(0);
            Router.Send(client.Room, 0x11, Result);
