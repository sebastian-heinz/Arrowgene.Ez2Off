...
{
    public class R13ServerTrait : ServerTrait
    {
        public R13ServerTrait(EzServer server) : base(server)
        {
        }
        ...
        public override void ClientDisconnected(EzClient client)
        {
            ...
            foreach (EzClient friendMeClient in friendedMe)
            {
                ...
                LobbyPacket.WriteFriend(friendUpdate, friend.FriendCharacterName, (short) friend.Sex,
