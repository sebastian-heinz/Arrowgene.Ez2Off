...
namespace Arrowgene.Ez2Off.Server.Reboot14.Packet.World
{
    ...
    /// </summary>
    public class ChatPrivate : Handler<EzServer>
    {
        public ChatPrivate(EzServer server) : base(server)
        {
        }
        ...
        public override void Handle(EzClient client, EzPacket packet)
        {
            ...
            if (receiver == client)
            {
                Logger.Error(client, $"Receiver Character: {receiverName} is same as sender");
                return;
            }
