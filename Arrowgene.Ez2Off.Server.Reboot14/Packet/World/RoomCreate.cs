        ...
        public override void Handle(EzClient client, EzPacket packet)
        {
            if (client.Room != null)
            {
                if (client.Room.GameType == GameType.SinglePlayer)
                {
                    ...
                    IBuffer roomCharacterPacket =  PacketBuilder.RoomPacket.CreateCharacterPacket(client.Room);
                    Router.Send(client, 10, roomCharacterPacket);

                    IBuffer announceRoomPacket =  PacketBuilder.RoomPacket.UpdateRoomStatus(client.Room);
            ...
            info.Name = packet.Data.ReadFixedString(21, Utils.KoreanEncoding);
