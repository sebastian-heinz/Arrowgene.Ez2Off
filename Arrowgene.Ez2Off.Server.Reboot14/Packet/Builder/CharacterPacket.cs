...
{
    public class CharacterPacket : ICharacterPacket
    {
        public IBuffer Create(EzClient client)
        {
        ...
        public void Write(IBuffer buffer, EzClient client)
        {
            ...
            buffer.WriteByte(0);
            buffer.WriteByte(0);
            buffer.WriteInt32(character.Exp); //Exp
            buffer.WriteInt32(Character.ExpForNextLevel(character)); //ExpForNextLevel
            ...
            buffer.WriteByte(0);
            buffer.WriteByte(1); //tutorial 0 = False | 1 = true 
            buffer.WriteByte(0);
            buffer.WriteByte(0);
            buffer.WriteByte(0);
            buffer.WriteByte(0);
            ...
            buffer.WriteByte(0);
            buffer.WriteByte(setting.SkinType); //Onlinn or AcadeType Set
            buffer.WriteByte(0);
        }
    }
}